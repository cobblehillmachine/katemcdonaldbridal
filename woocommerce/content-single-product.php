...
<!--
<?php if ( in_array( 'bridesmaids', $categories ) )  { ?>
			<div class="banner">10% off all bridesmaids dresses through March 31st using code <span>MARCH16</span></div>
		<?php } ?>
-->


<div class="single-product-wrap" itemscope itemtype="<?php echo woocommerce_get_product_schema(); ?>" id="product-<?php the_ID(); ?>" <?php post_class(); ?>>
